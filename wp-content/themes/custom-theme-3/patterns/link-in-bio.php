...
/**
 * Title: Link in Bio
 * Slug: custom-theme-3/link-in-bio
...
<div class="wp-block-group has-surface-background-color has-background" style="border-radius:30px;padding-top:3rem;padding-right:3rem;padding-bottom:3rem;padding-left:3rem">
	...
	<h3 class="wp-block-heading has-text-align-center has-lg-font-size"><?php echo esc_html__( 'Alex Rivers', 'acme' ); ?></h3>
	<!-- /wp:heading -->
	<!-- wp:paragraph {"align":"center"} -->
	<p class="has-text-align-center"><?php echo esc_html__( 'Writer · Product thinker · Always prototyping', 'acme' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-buttons">
		...
		<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link has-accent-background-color has-background-color has-text-color has-background" href="#"><?php echo esc_html__( 'Read the latest essay', 'acme' ); ?></a></div>
		<!-- /wp:button -->
		<!-- wp:button {"width":100,"className":"is-style-outline"} -->
		<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-outline"><a class="wp-block-button__link wp-element-button" href="#"><?php echo esc_html__( 'Subscribe to the newsletter', 'acme' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</div>
