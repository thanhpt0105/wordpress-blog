...
<p class="has-arial-serif-font-family" style="font-size:2rem;line-height:1.4;font-style:italic"><?php echo esc_html__( '“Slow pages, sharp words. This layout keeps readers leaning in till the last line.”', 'acme' ); ?></p>
	<!-- /wp:paragraph -->
...
<p class="has-text-color has-muted-color has-arial-sans-font-family" style="font-size:0.95rem;letter-spacing:0.18em;text-transform:uppercase"><?php echo esc_html__( 'Reader testimonial', 'acme' ); ?></p>
	<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
