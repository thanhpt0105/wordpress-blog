 ...
 * Slug: personal-blog/call-to-action
 * Categories: personalblog-cta
 */
?>
...
<div class="wp-block-cover is-light" style="border-radius:36px;min-height:360px"><span aria-hidden="true" class="wp-block-cover__background has-accent-background-color has-background-dim"></span><div class="wp-block-cover__inner-container">
	...
	<div class="wp-block-group">
		...
		<h2 class="wp-block-heading has-text-align-center" style="color:var(--wp--preset--color--background);font-size:2.4rem;line-height:1.3"><?php echo esc_html__( 'Ready to publish your next idea?', 'personalblog' ); ?></h2>
		<!-- /wp:heading -->
		<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"1.05rem","color":{"text":"var:preset|color|background"}}}} -->
		<p class="has-text-align-center" style="color:var(--wp--preset--color--background);font-size:1.05rem"><?php echo esc_html__( 'Use this space to pitch your newsletter, services, or flagship project.', 'personalblog' ); ?></p>
		<!-- /wp:paragraph -->
		...
		<div class="wp-block-buttons">
			...
			<div class="wp-block-button"><a class="wp-block-button__link has-background-background-color has-text-color has-background" href="#"><?php echo esc_html__( 'Start publishing', 'personalblog' ); ?></a></div>
		</div>
		<!-- /wp:buttons -->
	</div>
	<!-- /wp:group -->
